...
class InverseAnswerScreen extends StatelessWidget {
  InverseAnswerScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<InverseCameraCubit, InverseCameraState>(
        bloc: cameraCubit,
        builder: (context, state) {
          if(state is InverseSendResultLoading){
          return Center(child: CircularProgressIndicator());
         
        } else if(state is InverseSendResultError){
          return Center(child: Text(cameraCubit.error));
        }
        if(state is InverseSendResultSuccess){
          WidgetsBinding.instance.addPostFrameCallback((_) {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => InverseResultScreen(
