...
class InverseCameraSaveHistoryUseCase {
  InverseCameraRepo inverseCameraRepo = InverseCameraRepoImpl();

  Future<InverseCameraSaveHistoryModel> call(String inputText) async {
    return await inverseCameraRepo.saveHistory(inputText);
  }
}